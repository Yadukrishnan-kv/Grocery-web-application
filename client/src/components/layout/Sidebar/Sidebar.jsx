...
const navItems = [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        id: "MyCustomerRequests",
        label: "My Requests",
        path: "/sales/customer-requests/my",
      },
      { id: "SalesmanCustomers", label: "Customers", path: "/sales/customers" },
    ],
  },
  ...
  },
  {
    ...
    label: "Cheque Wallet",
    icon: "💰",
    path: "/delivery/wallet/cheque",
  },
  {
    id: "paymentRequestsdelivery",
    label: "Payment Requests",
    icon: "💰",
    path: "/delivery/payment-requests",
  },
  {
    id: "paymentRequestssales",
    label: "Payment Requests",
    icon: "💰",
                    ...
                    {item.subItems.map((subItem) => (
                      <li key={subItem.id}>
                        <button
                          ...
                          aria-current={
                            activeItem === subItem.id ? "page" : undefined
                          }
                        >
